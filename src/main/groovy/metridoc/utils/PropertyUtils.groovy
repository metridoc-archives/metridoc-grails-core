...
import static metridoc.utils.FileType.*

/**
 * Used by the {@link metridoc.plugins.PropertyPlugin} to grab properties form the classpath or system
 */
class PropertyUtils {
    ...
    def propertyFileOrder = [DEFAULT, HOME, METRIDOC_HOME, CLASSPATH, TEST_CLASSPATH]
