...
/**
 * COPIED DIRECTLY FROM APACHE's LineIterator in commons-io
 *
 * did this to reduce our dependency madness.  The only change we made was to use our IOUtils to close streams
 * silently
 *
