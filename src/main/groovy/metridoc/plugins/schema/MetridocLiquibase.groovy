...
import metridoc.utils.AssertState
...
class MetridocLiquibase {
     ...
     */
    void runMigration() {
        AssertState.notNull(dataSource, "A DataSource ${ERROR_MESSAGE_POSTFIX}")
        AssertState.notNull(schema, "A change log ${ERROR_MESSAGE_POSTFIX}")
