...
//@Mixin(WrapperInvariantCategory)
@Mixin(ShouldFailCategory)
class SortWrapperTest extends WrapperInvariantCategory{
	def wrapped
	...
	/**
		Now the wrapped behavior tests begin.  Note that this version of testIt
adds the order_by operation.
	*/
